...
import { errorResponse, SiteverifyError } from "./errors.js";
...
async function parseBody(request: Request): Promise<SiteverifyRequest> {
    ...
    throw new SiteverifyError(415, "invalid-content-type", `Unsupported Content-Type: ${contentType || "(missing)"}. Use application/json or application/x-www-form-urlencoded.`);
}
